<div class="w-full h-screen text-center bg-indigo-100 main-error-page">
  <svg
  ...
  >
    ...
    <g fill="none" fill-rule="evenodd">
      <path fill="#E0E7FF" d="M0 0H1366V800H0z" transform="translate(-448 -158)" />
      <g>
  ...
  <form action="">
    <button class="p-5 mt-8 text-white rounded-lg bg-violet-500">Go Back</button>
  </form>
