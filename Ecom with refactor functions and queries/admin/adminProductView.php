      ...
      <tbody>
        <?php foreach ($products as $product) { ?>
          <tr>
            ...
            <td class="border-b border-[#eee] py-5  dark:border-strokedark">
              <h5 class="font-medium text-black max-w-32 "><?php echo $product->name; ?></h5>
            </td>
            <td class="border-b border-[#eee] py-5  dark:border-strokedark">
              <h5 class="font-medium text-gray-600 max-w-44 "><?php echo $product->description; ?></h5>
            </td>
            <td class="border-b border-[#eee] py-5  dark:border-strokedark">
              <h5 class="font-medium text-gray-600 max-w-44 "><?php echo $product->price; ?></h5>
            </td>
            <td class="border-b border-[#eee] py-5  dark:border-strokedark">
              <h5 class="font-medium text-gray-600 max-w-44 "><?php echo $product->quantity; ?></h5>
            </td>
            <td class="border-b border-[#eee] py-5  dark:border-strokedark">
              <h5 class="font-medium text-gray-600 max-w-44 "><?php echo getCategoryName($product->category_id) ?></h5>
            </td>
            <td class=" border-b border-[#eee] py-5  dark:border-strokedark">
              <div class="flex items-start space-x-3.5">
                <a href="../productDetail.php?id=<?= $product->id ?>"class="hover:text-emerald-700">
                ...
                <a href="adminproductEdit.php?id=<?= $product->id ?>" class="hover:text-amber-600">
