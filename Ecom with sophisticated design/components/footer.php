<footer class="footer-section">
    <div class="container relative">
        ...
        <div class="row g-5 mb-5">
            <div class="col-lg-4">
                <div class="mb-4 footer-logo-wrap"><a href="#" class="footer-logo">Rangoon Super Center<span>.</span></a></div>
                <p class="mb-4">Crafted with excellent material. It perfectly complements my modern interior design. I'm extremely satisfied with the quality and style. Highly recommended!</p>
